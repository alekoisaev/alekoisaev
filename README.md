# Hi, I'm Almardan Isaev

**Senior Full stack Developer · Solidity / DeFi** | (GMT +4) · [alekoisaev@gmail.com](mailto:alekoisaev@gmail.com) | <a href="https://twitter.com/0xaleko">Twitter<a/>
### More info about me: <a href="https://github.com/alekoisaev/alekoisaev/blob/master/resume1.pdf">Click<a/>. 
---

Senior Full-stack developer . Hands-on experience with top lending, AMM and perp DEX protocols in on-chain space. Go the full cycle: write contracts, connect them to backend systems (Node.js, TypeScript, GraphQL, subgraphs), and build the frontend on top. Built backend infrastructure for L2 blockchain interaction, on-chain arbitrage systems. Lead core development of a fully on-chain generative art game. Worked with Move on Sui, Rust via Stylus SDK on Arbitrum. Run and maintain geth & reth nodes on VMs.

---

## Stack

+ **Languages - Solidity · Rust (Stylus SDK) · Move (Sui) · TypeScript · Python · JavaScript**
+ **DeFi - AMM · Lendings · perpetal Dex**
+ **Testing - Foundry (unit / fuzz / invariant) · Hardhat · Slither · Tenderly**
+ **Web - React · Next.js · NodeJS** 
+ **Web3 - ethers.js · viem · wagmi · web3-react · The Graph · Dune Analytics**
